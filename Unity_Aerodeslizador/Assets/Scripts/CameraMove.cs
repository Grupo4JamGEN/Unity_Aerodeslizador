...
{
    private float zFocus;         //   Note you can add a xFocus and a yFocus if you want the camera to follow x and y directions but for now it will only follow in the z axis.
